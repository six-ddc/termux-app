...
public final class TermuxPropertyConstants {
    ...
    public static final int IVALUE_TERMINAL_CURSOR_STYLE_BLOCK = TerminalEngine.TERMINAL_CURSOR_STYLE_BLOCK;
    public static final int IVALUE_TERMINAL_CURSOR_STYLE_UNDERLINE = TerminalEngine.TERMINAL_CURSOR_STYLE_UNDERLINE;
    public static final int IVALUE_TERMINAL_CURSOR_STYLE_BAR = TerminalEngine.TERMINAL_CURSOR_STYLE_BAR;
    public static final int DEFAULT_IVALUE_TERMINAL_CURSOR_STYLE = TerminalEngine.DEFAULT_TERMINAL_CURSOR_STYLE;
    ...
    public static final int IVALUE_TERMINAL_TRANSCRIPT_ROWS_MIN = TerminalEngine.TERMINAL_TRANSCRIPT_ROWS_MIN;
    public static final int IVALUE_TERMINAL_TRANSCRIPT_ROWS_MAX = TerminalEngine.TERMINAL_TRANSCRIPT_ROWS_MAX;
    public static final int DEFAULT_IVALUE_TERMINAL_TRANSCRIPT_ROWS = TerminalEngine.DEFAULT_TERMINAL_TRANSCRIPT_ROWS;
